...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsD3_componentJs = __webpack_require__(1);
	
	var _jsD3_componentJs2 = _interopRequireDefault(_jsD3_componentJs);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var colorScale = _d32["default"].scale.category10([0, 1, 2, 3]);
	var pieChart = _d32["default"].layout.pie().sort(null);
	
	var newArc = _d32["default"].svg.arc();
	newArc.outerRadius(170).innerRadius(40);
	
	var path = _d32["default"].select("svg").append("g").attr("transform", "translate(250,190)").selectAll("path").data(pieChart(chartData)).enter().append("path").attr("d", newArc).style("fill", function (d, i) {
	    return colorScale(i);
	...
	var D3Component = {
	    updatePieChart: function updatePieChart(event) {
	        ...
	        path.data(pieChart(chartData)).transition().duration(1000).attr("d", newArc).attrTween("d", arcTween);
	
	        function arcTween(a) {
	            var i = _d32["default"].interpolate(this._current, a);
	            this._current = i(0);
	            return function (t) {
	                return newArc(i(t));
	            };
	    ...
	    inputHandler: function inputHandler(event) {
	        ...
	        try {
	            if (!isNaN(parseInt(africanInput)) && parseInt(africanInput) != 0 && (!isNaN(parseInt(americanInput)) && parseInt(americanInput) != 0) && (!isNaN(parseInt(europeanInput)) && parseInt(europeanInput) != 0)) {
